			...
			<div className="container">
				...
				<div className="row g-3">
					<div className="col-md-4">
						<div className="row my-2">
							<div className="col">
								<h3 className="border-bottom border-dark">Headings</h3>
							</div>
						</div>
						<div className="row my-2">
							<h1>Heading 1</h1>
					...
					<div className="col-md-8">
						<div className="row my-2">
						<div className="col">
								<h3 className="border-bottom border-dark">Display Headings</h3>
							</div>
						</div>
						<div className="row my-2">
				...
				<div className="row g-3">
					<div className="col-md-4">
						<div className="row my-2">
							<div className="col">
								<h3 className="border-bottom border-dark">Body - Small</h3>
							</div>
						</div>
						<div className="row my-2">
							<p className="small">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur vel bibendum lorem. Morbi convallis convallis diam sit amet lacinia. Aliquam in elementum tellus.</p>
							<p className="small"><strong>Body Bold | lorem ipsum dolor sit amet</strong></p>
							<p className="small"><em>Body Italic | lorem ipsum dolor sit amet</em></p>
							<p className="small"><strong><em>Body Bold Italic | lorem ipsum dolor sit amet</em></strong></p>
						</div>
					</div>
					<div className="col-md-4">
						<div className="row my-2">
							<div className="col">
								<h3 className="border-bottom border-dark">Body</h3>
							</div>
						</div>
						<div className="row my-2">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur vel bibendum lorem. Morbi convallis convallis diam sit amet lacinia. Aliquam in elementum tellus.</p>
							<p><strong>Body Bold | lorem ipsum dolor sit amet</strong></p>
							<p><em>Body Italic | lorem ipsum dolor sit amet</em></p>
							<p><strong><em>Body Bold Italic | lorem ipsum dolor sit amet</em></strong></p>
						</div>
					</div>
					<div className="col-md-4">
						<div className="row my-2">
							<div className="col">
								<h3 className="border-bottom border-dark">Body - Large</h3>
							</div>
						</div>
						<div className="row my-2">
							<p className="large">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eu turpis molestie, dictum est a, mattis tellus. Sed dignissim, metus nec fringilla accumsan, risus sem sollicitudin lacus, ut interdum tellus elit sed risus. Maecenas eget condimentum velit, sit amet feugiat lectus. Suspendisse ac rhoncus nisl, eu tempor urna. Curabitur vel bibendum lorem. Morbi convallis convallis diam sit amet lacinia. Aliquam in elementum tellus.</p>
							<p className="large"><strong>Body Bold | lorem ipsum dolor sit amet</strong></p>
							<p className="large"><em>Body Italic | lorem ipsum dolor sit amet</em></p>
							<p className="large"><strong><em>Body Bold Italic | lorem ipsum dolor sit amet</em></strong></p>
						</div>
					</div>
				</div>
			</div>
